                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "result": {
                                            "$ref": "#/definitions/controller.LuckyWheelStatusResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "controller.LuckyWheelStatusResponse": {
            ...
            "properties": {
                ...
                "general_enabled": {
                    "description": "通用幸运转盘开关配置原值",
                    "type": "string",
                    "example": "off"
                },
                "news_close_enabled": {
                    "description": "新用户幸运转盘界面关闭开关配置原值",
                    "type": "string",
                    "example": "on"
                },
                "news_enabled": {
                    "description": "新用户幸运转盘开关配置原值",
                    "type": "string",
                    "example": "off"
                },
                "today_played": {
                    "description": "北京时间当天是否已有参与标记",
                    "type": "boolean",
                    "example": false
                }
            }
